...
<div class="flex-collumn-container" style="align-items: normal;">
    ...
    <div class="flex-row-container">
        {#if darkTheme}
            ...
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>changeTheme(false)}>Light</div>
            &nbsp &nbsp
        ...
        {:else}
            ...
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>changeTheme(true)}>Dark</div>
        {/if}
    </div>
    ...
    <div class="flex-row-container">
        {#if globalSettings.useTabGroupInOpenAllTabs == "openTabGroup"}
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em; background-color: #00ff0022;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabGroup')}>Open in Tab Group</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('open')}>Open in Current Window</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabWindow')}>Open in New Window</div>
        {:else if globalSettings.useTabGroupInOpenAllTabs == "openTabWindow"}
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabGroup')}>Open in Tab Group</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('open')}>Open in Current Window</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em; background-color: #00ff0022;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabWindow')}>Open in New Window</div>
        {:else}
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabGroup')}>Open in Tab Group</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em; background-color: #00ff0022;" onclick={(e)=>setUseTabGroupInOpenAllTabs('open')}>Open in Current Window</div>
            &nbsp &nbsp
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            <div class="rounded-button pointer" style="font-size: 1.2em;" onclick={(e)=>setUseTabGroupInOpenAllTabs('openTabWindow')}>Open in New Window</div>
        {/if}
    ...
    <div class="flex-row-container">
        ...
        <input id="aaaa" type="checkbox" class="large-checkbox" style="background-color: aqua;" bind:checked={reloadBookmarkSectionOnChange} onchange={setReloadBookmarkSectionOnChange}/>
    </div>
    <div class="flex-row-container">
        <h1>Reload Open-Tabs section on Tab updates</h1>
        <input id="aaaa" type="checkbox" class="large-checkbox" bind:checked={reloadOpenTabsSectionOnChange} onchange={setReloadOpenTabsSectionOnChange}/>
    </div>
</div>
